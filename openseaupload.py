...
def main_program_loop():
    ...
    while end_num >= start_num:
        ...
        if is_polygon.get():
            ...
            driver.find_element(By.XPATH, '//*[@id="main"]/div/div/section/div[2]/form/div[7]/div/div[2]/div[1]/div/img').click()

        driver.find_element_by_xpath('//*[@id="__next"]/div[1]/main/div/div/section/div[2]/form/div/div[1]/span/button').click()
        time.sleep(1)
